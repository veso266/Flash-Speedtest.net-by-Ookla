...
<head>
	<script type="text/javascript" src="./static/jst/zdconsent.js?version=2573198" async="true"></script>
	...
	<title>Flash Speedtest.net by Ookla - Register</title>
	...
	<!--[if lte IE 6]>
		...
		<![endif]-->
	<link rel="canonical" href="http://www.speedtest.net/user-register.php" />
	...
	<meta property="og:title" content="Flash Speedtest.net by Ookla - Register" />
	<meta property="og:type" content="website" />
	<meta property="og:site_name" content="Speedtest.net" />
	<meta property="og:url" content="http://www.speedtest.net/user-register.php" />
	<meta property="og:image" content="http://c.speedtest.net/images/share-logo.png" />
  ...
  if (window.abp && {CRITEO_ENABLED}) {  
    ads = AdManager.criteo({DFP_ZONES}, {DFP_TARGETS});
    ads.display("{DFP_DISPLAY}");
  } else {
    if (true && !window.isBlocked) {
      ads = AdManager.dfpPrebid({DFP_ZONES}, {DFP_TARGETS}, {"disableInitialLoad": true});
    } else {
      ads = AdManager.internal({DFP_ZONES}, {DFP_TARGETS});
    }
...
<div id="register-main-top">
<p>Fill out the form below. A confirmation email will be sent to you.<br/>
Already registered and forgot your password? <a href="password-reset.php">Reset it here.</a></p>
</div><!--/register-main-top-->

<img id="register-header-icon" src="images/placeholder-register-header.png" alt="" />
...
<label for="reg-email-1">Email address (this will be your login):<br>
<small>(never sold or spammed)</small></label>
<input id="reg-email-1" type="text" name="reg-email-1" class="field " value=""/>

<label for="reg-email-2">Email address again:</label>
<input id="reg-email-2" type="text" name="reg-email-2" class="field " value=""/>

<label for="reg-pw-1">Choose a password:</label>
<input id="reg-pw-1" type="password" name="reg-pw-1" class="field " />

<label for="reg-pw-2">Password again:</label>
<input id="reg-pw-2" type="password" name="reg-pw-2" class="field " />

<!--
	this form is a fixed height (due to the background image). please take that into account if you change anything
	remember to leave room for the message below, which isn't always visible
-->

<div id="user-msg">
	<h2>Adblock Warning</h2>
	Your adblocker may be blocking the Recaptcha input. Please turn your adblocker off in order to register an account.
</div>
...
<p>
	<label for="reg-news" class="reg-news"><input id="reg-news" type="checkbox" name="reg-news" value="1" checked>
		By clicking this box, you agree to receive emails, newsletters, special offers and other updates from Ookla.
		You may unsubscribe from the newsletters at any time.
	</label>
</p>

<p>By submitting the information in this form, you are consenting to our <a href="/terms" target="_blank">Terms of Use</a> and <a href="/privacy" target="_blank">Privacy Policy</a>.</p>


<div id="form-submit-reg"><input type="submit" value="SUBMIT"></input></div>
...
<ul>
<li>Registering gives you the ability to create Speed Waves</li>
<li>Reserve a unique nickname identifying you on Speedtest.net</li>
<li>Label and group your Internet connections</li>
<li>Remove test records from your result history</li>
<li>View your past results from any computer</li>
</ul>

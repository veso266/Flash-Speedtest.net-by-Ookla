...
<head>
	<script type="text/javascript" src="../static/jst/zdconsent.js?version=2574110" async="true"></script>
	...
	<title>Flash Speedtest.net by Ookla - Login</title>
	...
	<!--[if lte IE 6]>
		...
		<![endif]-->
	<link rel="canonical" href="http://www.speedtest.net/user-login.php" />
	...
	<meta property="og:title" content="Flash Speedtest.net by Ookla - Login" />
	<meta property="og:type" content="website" />
	<meta property="og:site_name" content="Speedtest.net" />
	<meta property="og:url" content="http://www.speedtest.net/user-login.php" />
...
<div id="login-main-top">
<p>Fill out the form below to login.<br/>
Forgot your password? <a href="password-reset.php">Reset it here</a>.<br/>
Don't have an account? <a href="user-register.php">Create one here</a>.</p>
</div><!--/login-main-top-->

<img id="login-header-icon" src="images/placeholder-login-header.png" alt="" />
...
<fieldset>
<input id="action" type="hidden" name="action" value="login" />
<input id="action" type="hidden" name="referrer" value="" />
<label for="login-email">Login (Email Address):</label>
<input id="login-email" type="text" name="email" class="field" value=""/>

<label for="login-pw">Password:</label>
<input id="login-pw" type="password" name="password" class="field" />
...
<div id="form-submit-login"><input type="submit" value="LOGIN"></input></div>

package
{
   ...
   public class Tile4x2 extends GenericTile
   {
      ...
      public function Tile4x2(param1:String, param2:Object)
      {
         ...
         super(4,2,test,results);
         trace("Tile4x2: " + this + " " + test);
         ...
         try
         {
            ...
            RuntimeManager.getSingleton().addInstance(this,"title",new Rectangle(0,0,379.2,33.1),<tlfTextObject type="Paragraph" editPolicy="readOnly" columnCount="auto" columnGap="20" verticalAlign="top" firstBaselineOffset="auto" paddingLeft="2" paddingTop="2" paddingRight="2" paddingBottom="2" background="false" backgroundColor="#ffffff" backgroundAlpha="1" border="false" borderColor="#000000" borderAlpha="1" borderWidth="1" paddingLock="false" multiline="true" antiAliasType="advanced" embedFonts="true"><TextFlow lineBreak="toFit" locale="en_US" whiteSpaceCollapse="preserve" version="2.0.0" xmlns="http://ns.adobe.com/textLayout/2008"><p direction="ltr" paragraphEndIndent="0" paragraphStartIndent="0" textAlign="start" textIndent="0"><span baselineShift="0" color="#383e42" fontFamily="2Custom*" fontSize="12" fontStyle="normal" fontWeight="normal" kerning="auto" lineHeight="103.333333%" trackingRight="0%">Title</span></p></TextFlow></tlfTextObject>,null,undefined,0,155,"",false,true);
            ...
            RuntimeManager.getSingleton().addInstance(this,"skipped",new Rectangle(0,0,379.3,163.1),<tlfTextObject type="Paragraph" editPolicy="readOnly" columnCount="auto" columnGap="20" verticalAlign="middle" firstBaselineOffset="auto" paddingLeft="2" paddingTop="2" paddingRight="2" paddingBottom="2" background="false" backgroundColor="#ffffff" backgroundAlpha="1" border="false" borderColor="#000000" borderAlpha="1" borderWidth="1" paddingLock="false" multiline="true" antiAliasType="advanced" embedFonts="true"><TextFlow lineBreak="toFit" locale="en_US" whiteSpaceCollapse="preserve" version="2.0.0" xmlns="http://ns.adobe.com/textLayout/2008"><p direction="ltr" paragraphEndIndent="0" paragraphStartIndent="0" textAlign="center" textIndent="0"><span baselineShift="0" color="#869096" fontFamily="2Custom*" fontSize="14" fontStyle="normal" fontWeight="normal" kerning="auto" lineHeight="101.818182%" trackingRight="0%">Test Skipped</span></p></TextFlow></tlfTextObject>,null,undefined,99,114,"",true,false);
            RuntimeManager.getSingleton().addInstance(this,"error",new Rectangle(0,0,379.3,22.4),<tlfTextObject type="Paragraph" editPolicy="readOnly" columnCount="auto" columnGap="20" verticalAlign="top" firstBaselineOffset="auto" paddingLeft="2" paddingTop="2" paddingRight="2" paddingBottom="2" background="false" backgroundColor="#ffffff" backgroundAlpha="1" border="false" borderColor="#000000" borderAlpha="1" borderWidth="1" paddingLock="false" multiline="true" antiAliasType="advanced" embedFonts="true"><TextFlow lineBreak="toFit" locale="en_US" whiteSpaceCollapse="preserve" version="2.0.0" xmlns="http://ns.adobe.com/textLayout/2008"><p direction="ltr" paragraphEndIndent="0" paragraphStartIndent="0" textAlign="center" textIndent="0"><span baselineShift="0" color="#869096" fontFamily="2Custom*" fontSize="14" fontStyle="normal" fontWeight="normal" kerning="auto" lineHeight="101.818182%" trackingRight="0%">Test Skipped</span></p></TextFlow></tlfTextObject>,null,undefined,115,155,"",true,false);
            RuntimeManager.getSingleton().addInstance(this,"msg",new Rectangle(0,0,379.3,114.25),<tlfTextObject type="Paragraph" editPolicy="readOnly" columnCount="auto" columnGap="20" verticalAlign="top" firstBaselineOffset="auto" paddingLeft="2" paddingTop="2" paddingRight="2" paddingBottom="2" background="false" backgroundColor="#ffffff" backgroundAlpha="1" border="false" borderColor="#000000" borderAlpha="1" borderWidth="1" paddingLock="false" multiline="true" antiAliasType="advanced" embedFonts="true"><TextFlow lineBreak="toFit" locale="en_US" whiteSpaceCollapse="preserve" version="2.0.0" xmlns="http://ns.adobe.com/textLayout/2008"><p direction="ltr" paragraphEndIndent="0" paragraphStartIndent="0" textAlign="center" textIndent="0"><span baselineShift="0" color="#869096" fontFamily="1Custom*" fontSize="12" fontStyle="normal" fontWeight="normal" kerning="auto" ligatureLevel="uncommon" lineHeight="101.818182%" trackingRight="0%">Message about why it was skipped or had an error</span></p></TextFlow></tlfTextObject>,null,undefined,115,155,"",true,false);
         }
         finally
         {

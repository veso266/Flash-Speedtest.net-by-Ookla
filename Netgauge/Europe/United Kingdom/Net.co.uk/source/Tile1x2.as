package
{
   ...
   public class Tile1x2 extends GenericTile
   {
      ...
      public function Tile1x2(param1:String, param2:Object)
      {
         ...
         super(1,2,test,results);
         trace("Tile1x2: " + this + " " + test);

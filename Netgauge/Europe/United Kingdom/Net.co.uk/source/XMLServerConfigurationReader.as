package
{
   ...
   public class XMLServerConfigurationReader implements ServerConfigurationReader
   {
      ...
      protected var data:XMLList = null;
      
      protected var controller:SpeedTestController;
      
      public function XMLServerConfigurationReader(param1:CustomSpeedTestController)
      {
         super();
      ...
      public function getServer(param1:Number) : Object
      {
         ...
         {
            _loc2_ = this.data[param1 - 1].attributes();
            return XMLEngineConfigurationReader.getArray(_loc2_);
         }
         return {};
      }
      ...
      public function getServerMethod(param1:Number, param2:Number) : Object
      {
         ...
         {
            _loc4_ = this.data[param1 - 1].method[param2].attributes();
            return XMLEngineConfigurationReader.getArray(_loc4_);
         }
         return {};
      }
   }
